...
const features = [
  {
    icon: Mic,
    title: "Дуут сануулагч",
    desc: "Байгалийн хэлээр ярь. AI нэр, огноо, цаг, чухал байдлыг автоматаар ялган таньдаг.",
  },
  {
    icon: Bell,
    title: "Ухаалаг мэдэгдэл",
    desc: "Цаг тухайд нь сануулга, дуусах хугацааны анхааруулга, зөөлөн дагаж мөрдөлт.",
  },
  {
    icon: Sparkles,
    title: "AI ухаалаг санал",
    desc: "Оргил цагийг тань илрүүлж, аширгүй хэв маягийг таслан зогсооно.",
  },
  {
    icon: BarChart2,
    title: "Тайлан & Шинжилгээ",
    desc: "Үзэсгэлэнтэй график, долоо хоног бүрийн дүгнэлт.",
  },
];
    ...
    <div className="min-h-screen bg-white text-gray-900 flex flex-col">
      ...
      <header className="flex items-center justify-between px-8 py-4 border-b border-gray-100">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/login"
            className="text-sm bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-full transition-colors"
          >
            Үнэгүй эхлэх
          </Link>
        </div>
      ...
      <main className="flex-1">
        ...
        <section className="flex flex-col items-center text-center px-6 pt-20 pb-16">
          ...
          <h1 className="text-5xl sm:text-6xl font-extrabold leading-tight tracking-tight mb-6 max-w-3xl">
            Чухал зүйлсийг <span className="text-indigo-600">хэзээ ч</span>{" "}
            мартахгүй.
          </h1>

          <p className="text-lg text-gray-500 max-w-xl leading-relaxed mb-10">
            Текст эсвэл дуугаар сануулагч үүсгэж, бүтээмжтэй байж, AI амьдралыг
            тань зохион байгуулаг — ухаалаг мэдэгдэл, санал, үзэсгэлэнтэй
            тайлангуудаар.
          </p>
